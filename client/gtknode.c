...
static void gtk_nodes_node_set_property(GObject *object, guint param_id, const GValue *value, GParamSpec *pspec);
static void gtk_nodes_node_get_property(GObject	*object, guint param_id, GValue *value, GParamSpec *pspec);
/* widget class basics */
...
static void gtk_nodes_node_size_allocate(GtkWidget *widget, GtkAllocation *allocation);
static gboolean gtk_nodes_node_draw(GtkWidget *widget, cairo_t *cr);
/* widget class events */
static gboolean gtk_nodes_node_button_press(GtkWidget *widget, GdkEventButton *event);
static gboolean gtk_nodes_node_button_release(GtkWidget	*widget, GdkEventButton *event);

/* widget class accessibility support */
static void gtk_nodes_node_adjust_size_request(GtkWidget *widget, GtkOrientation orientation, gint *minimum_size,
		gint *natural_size);
...
void gtk_nodes_node_set_icon_name (GtkNodesNode *node, const gchar *icon_name)
{
	GtkNodesNodePrivate *priv;
 ...
 */
GtkWidget *gtk_nodes_node_item_add (GtkNodesNode *node, GtkWidget *widget, GtkNodesNodeSocketIO mode)
{
...
{
	return g_object_new (GTKNODES_TYPE_NODE, "orientation", GTK_ORIENTATION_VERTICAL, NULL);
}
