...
static void	 gtk_nodes_node_socket_set_property(GObject *object, guint param_id, const GValue *value, GParamSpec *pspec);
static void	 gtk_nodes_node_socket_get_property(GObject *object, guint param_id, GValue *value, GParamSpec *pspec);
...
static void	 gtk_nodes_node_socket_size_allocate(GtkWidget *widget, GtkAllocation *allocation);
static gboolean gtk_nodes_node_socket_draw(GtkWidget *widget, cairo_t *cr);

/* widget class size requests */
static void	 gtk_nodes_node_socket_get_preferred_width(GtkWidget *widget, gint *minimum, gint *natural);
static void	 gtk_nodes_node_socket_get_preferred_height(GtkWidget *widget, gint *minimum, gint *natural);
/* widget class events */
static gboolean gtk_nodes_node_socket_button_press(GtkWidget *widget, GdkEventButton *event);
static gboolean gtk_nodes_node_socket_motion_notify(GtkWidget *widget, GdkEventMotion *event);

/* internals */
static void	 gtk_nodes_node_socket_drag_begin(GtkWidget *widget, GdkDragContext *context, gpointer user_data);
static gboolean gtk_nodes_node_socket_drag_motion(GtkWidget *widget, GdkDragContext *context,
		gint x, gint y, guint time);
static void	 gtk_nodes_node_socket_drag_data_received(GtkWidget *widget, GdkDragContext *context,
		gint x, gint y, GtkSelectionData *selection_data, guint info, guint32 time, GtkNodesNodeSocket *socket);
...
static void gtk_nodes_node_socket_class_init (GtkNodesNodeSocketClass *class)
{
